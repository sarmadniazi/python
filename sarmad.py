...
def app():
    ...
    print()
    print("TYPE 4 FOR COMPUTER SCIENCE")
    print("TYPE 5 FOR DIGITAL WORD")
    print("TYPE 6 FOR DATA SCIENCE")
    print()
...
def calcy():
    print("""पायथन ऐप कोर्स में आपका स्वागत है,अंग्रेजी के लिए 1 दबाएँ.हिंदी के लिए 2 दबाएँ""")
    print("कंप्यूटर विज्ञान के लिए 1 दबाएँ")
    print("डिजिटल वर्ड के लिए 2 दबाएँ")
    print("डेटा विज्ञान के लिए 3 दबाएँ")
    print()
    y = int(input("हिंदी के लिए 2 दबाएँ"))
